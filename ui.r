ui <- fluidPage(
  ...
  h1("Calcular boleta de honorarios"),
  ...
  h2("Calcular boleta de honorarios 2021 con 11.5%"),
  ...
  h2("Calcular boleta de honorarios 2021 con 14,5%"),
  ...
  h2("Calcular boleta de honorarios 2020 con 10,75%"),
  ...
  h2("Calcular boleta de honorarios 2022 con 12,25%"),
  ...
  h2("¿Cuándo tengo que calcular usando el 14.5%?"),
